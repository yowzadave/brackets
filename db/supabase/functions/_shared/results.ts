...
// 11:00–02:00 in the given IANA timezone is "active" (i.e. through 01:59, so
// an hourly cron's 01:00 tick still syncs matches that finish after midnight).
// Invalid/empty tz → always active (don't block the sync on a
// misconfiguration).
